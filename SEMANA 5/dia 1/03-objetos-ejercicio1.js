...
// EJERCICIO 2
//DEVUELVE EL NOMBRE DE LA PELICULA CON MAYOR POPULARIDAD
//HINT:
//CAMPO O ANALIZAR POPULARITY
//ITERAR TODAS LAS PELICULAS GUARDANDO:
//1. EL INDEX O POSICION DE LA PELICULA CON MAYOR POPULARIDAD
...
function peliculaConMayorPopularidad() {
    ...
    //para que salga con el puntaje y posicion se realiza los siguientes
    //console.log('mayor popularidad', mayorPopularidad);
    //console.log('posicion de mayor popularidad', posicionMP);
}
console.log('pelicula mas popular', peliculaConMayorPopularidad());
...
//EJERCICIO 4
//funcion que imprime los generos a los que pertenece la primera pelicula
//es decir , la pelicula de la posicion 0

function generosDeLaPrieraPelicula() {
